...
# 27.07.2024 Знову пишу по книжці , до курсів так і не доріс , пахую. 
# спробую зробити гру щось типу миркіних гонок/коікера про корівок і молоко.
# концепт є, залишилось реалізувати на достатньому рівні.