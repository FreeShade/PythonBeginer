# Почніть на базі задачі 8_10.ру . Викличте функцію сенд меседж, передавши її КОПІЮ до списку
# повідомлень , оригінальний перелік повинен зберегтись.
...
# вкінці виведіть обидва переліки. Які збереглися.
print(messages_list)
print(sent_messages)
